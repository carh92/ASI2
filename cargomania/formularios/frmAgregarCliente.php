...
<table>
	...
	<tr>
		...
		<td><input type="text" name="txtEmpresa" id="txtEmpresa" value="<?php echo $nomb_empr ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Giro:</th>
		<td><input type="text" name="txtGiro" id="txtGiro" value="<?php echo $giro ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Numero de Registro:</th>
		<td><input type="text" name="txtRegistro" id="txtRegistro"  value="<?php echo $numero_reg ?>" required/><font color="#ff0000">*</font></td>
	</tr>

	<tr>
		<th>Direccion:</th>
		<td><input type="text" name="txtDireccion" id="txtDireccion"  value="<?php echo $direccion ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Nombre Representante:</th>
		<td><input type="text" name="txtNom_repre" id="txtNom_repre"  value="<?php echo $nombre_repre ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Apellido Representante:</th>
		<td><input type="text" name="txtApell_repre" id="txtApell_repre"  value="<?php echo $apellido_repre ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Telefono Representante:</th>
		<td><input type="text" name="txtTel_repre" id="txtTel_repre"  value="<?php echo $telefono_repre ?>" required/><font color="#ff0000">*</font></td>
	</tr>

	<tr>
		<th>Email Representante:</th>
		<td><input type="email" name="txtEmail_repre" id="txtEmail_repre"  value="<?php echo $email_repre ?>" required/><font color="#ff0000">*</font></td>
	</tr>
...
<table>
	<tr><th>Codigo</th><th>Nombre empresa</th><th>Giro</th><th>N Registro</th><th>Direccion</th><th>Nombre representante</th><th>Apellido representante</th><th>Telefono</th><th>Email</th><th>Opcion</th></tr>
<?php 
