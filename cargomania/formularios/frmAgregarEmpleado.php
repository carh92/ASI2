...
<table>
	...
	<tr>
		...
		<td><input type="text" name="txtNombre" id="txtNombre" value="<?php echo $nombre_epll ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Apellido Empleado:</th>
		<td><input type="text" name="txtApellido" id="txtApellido" value="<?php echo $apellido_epll ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Direccion:</th>
		<td><input type="text" name="txtDireccion" id="txtDireccion"  value="<?php echo $direccion_epll ?>" required/><font color="#ff0000">*</font></td>
	</tr>

	<tr>
		<th>Telefono:</th>
		<td><input type="text" name="txtTelefono" id="txtTelefono"  value="<?php echo $telefono_epll ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Correo:</th>
		<td><input type="email" name="txtCorreo" id="txtCorreo"  value="<?php echo $correo_epll ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Numero de Seguro:</th>
		<td><input type="text" name="txtNum_seg" id="txtNum_seg"  value="<?php echo $num_seguroo ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	...
	<tr>
		<th>Sucursal:</th>
		<td><select name="lstSucursall" id="lstSucursall" required>
			<?php 
