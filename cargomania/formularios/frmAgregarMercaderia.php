...
<table>
	...
	<tr>
		<th>Codigo:</th>
		<td><input type="number" name="txtCodigo" id="txtCodigo" value="<?php echo $codigo ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Nombre:</th>
	...
	<tr>
		<th>Tipo:</th>
		<td><input type="text" name="txtTipo" id="txtTipo" value="<?php echo $tip ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Descripcion:</th>
		<td><input type="text" name="txtDescripcion" id="txtDescripcion"  value="<?php echo $des ?>" required/><font color="#ff0000">*</font></td>
	</tr>
