...
<table>
	...
	<tr>
		...
		<td><input type="text" name="txtPeso" id="txtPeso" value="<?php echo $peso ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Cobro por Volumen:</th>
		<td><input type="text" name="txtVol" id="txtVol" value="<?php echo $vol ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	...
	<tr>
		<th>Cliente:</th>
		<td><select name="lstCliente" id="lstCliente" required>
			<?php 
