...
<table>
	...
	<tr>
		...
		<td><input type="text" name="txtNomb_Aget" id="txtNomb_Aget" value="<?php echo $nomb_aget ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Giro:</th>
		<td><input type="text" name="txtdireccion_aget" id="txtdireccion_aget" value="<?php echo $direccion_aget ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Numero de Registro:</th>
		<td><input type="text" name="txtnombre_repre" id="txtnombre_repre"  value="<?php echo $nombre_repre ?>" required/><font color="#ff0000">*</font></td>
	</tr>

	<tr>
		<th>Direccion:</th>
		<td><input type="text" name="txtapellido_repre" id="txtapellido_repre"  value="<?php echo $apellido_repre?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Nombre Representante:</th>
		<td><input type="text" name="txtpais_aget" id="txtpais_aget"  value="<?php echo $pais_aget ?>" required/><font color="#ff0000">*</font></td>
	</tr>
...
<table>
	<tr><th>Codigo</th><th>Nombre Empresa</th><th>Giro</th><th>Numero de Registro</th><th>Direccion</th><th>Nombre Representante</th><th>Opcion</th></tr>
<?php 
...
if($consultarAgenteBodega->rowCount()>0){
	while($agentebodega=$consultarAgenteBodega->fetch(PDO::FETCH_OBJ)){
		...
		<td>".$agentebodega->nombre_repre_aget_bod."</td><td>".$agentebodega->apellido_repre_aget_bod."</td><td>".$agentebodega->pais_aget_bod."</td><td><a href='?mod=agregar_agentebodega&id=".$agentebodega->aget_bod_id."'>Mostrar</a></td></tr>";
	}
}
?>
</table>