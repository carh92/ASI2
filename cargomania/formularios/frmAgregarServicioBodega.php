...
<table>
	...
	<tr>
		...
		<td><input type="text" name="txtnomb_serv" id="txtnomb_serv" value="<?php echo $nomb_serv ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Precio del servicio:</th>
		<td><input type="text" name="txtprecio_serv" id="txtprecio_serv" value="<?php echo $precio_serv ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	
	<tr>
		<th>Agente:</th>
		<td><select name="lstAgente" id="lstAgente" required>
			<?php 
