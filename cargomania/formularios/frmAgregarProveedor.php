...
<table>
	...
	<tr>
		<th>Nombre:</th>
		<td><input type="text" name="txtNombre" id="txtNombre" value="<?php echo $nombre ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Pais:</th>
		<td><input type="text" name="txtPais" id="txtPais" value="<?php echo $pais ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Direccion:</th>
	...
	<tr>
		<th>Telefono:</th>
		<td><input type="text" name="txtTelefono" id="txtTelefono"  value="<?php echo $telefono ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
		<th>Correo:</th>
		<td><input type="email" name="txtCorreo" id="txtCorreo"  value="<?php echo $correo ?>" required/><font color="#ff0000">*</font></td>
	</tr>
	<tr>
	<tr>
